...
function throttle(fn, delay, mustRunDelay) {
  ...
  var t_start;
  return function() {
    var context = this, args = arguments, t_curr = +/* @__PURE__ */ new Date();
    clearTimeout(timer);
    if (!t_start) {
      t_start = t_curr;
    }
...
var script = {
  ...
  watch: {
    ...
    value: function value(current) {
      ...
      if (!step || current < 0 || current > this.sliderItems.length - 1) {
        return;
      }
  ...
  methods: {
    ...
    auto: function auto() {
      var this$1 = this;
      if (!this.autoplay || this.isStopped) {
        return;
      }
      if (this.timer) {
...
var __vue_render__ = function() {
  ...
  return _c("div", { staticClass: "slider", style: { width: _vm.width, height: _vm.height }, on: { "mouseenter": _vm.handleMouseenter, "mouseleave": _vm.handleMouseleave } }, [!_vm.sliderItems.length ? _vm._t("loading", [_vm._m(0)]) : _vm._e(), _vm._v(" "), _c("div", { ref: "touchArea", staticClass: "slider-items" }, [_vm._t("default")], 2), _vm._v(" "), _vm.indicators ? _c("div", { class: "slider-indicators slider-indicators-" + _vm.indicators, on: { "click": function($event) {
    $event.stopPropagation();
  } } }, _vm._l(_vm.sliderItems.length, function(i) {
    return _c("span", { key: i, staticClass: "slider-indicator-icon", class: { "slider-indicator-active": _vm.currentIndex === i - 1 }, on: { "click": function($event) {
      return _vm.handleIndicator(i - _vm.currentIndex - 1);
    } } });
  }), 0) : _vm._e(), _vm._v(" "), _vm.controlBtn ? [_c("button", { staticClass: "slider-btn slider-btn-left", attrs: { "type": "button", "aria-label": _vm.prevBtnLabel }, on: { "click": function($event) {
    $event.stopPropagation();
    return _vm.prev($event);
  } } }, [_c("i", { staticClass: "slider-icon slider-icon-left", attrs: { "aria-hidden": "true" } })]), _vm._v(" "), _c("button", { staticClass: "slider-btn slider-btn-right", attrs: { "type": "button", "aria-label": _vm.nextBtnLabel }, on: { "click": function($event) {
    $event.stopPropagation();
  ...
  methods: {
    init: function init2() {
      ...
      this.$nextTick(function() {
        return this$1.initAnimation = false;
      });
    },
...
var __vue_render__$1 = function() {
  ...
  var _h = _vm.$createElement;
  var _c = _vm._self._c || _h;
  return _c("transition", { attrs: { "name": _vm.initAnimation ? "" : _vm.animation + "-" + (_vm.direction ? "left" : "right") } }, [_c("div", _vm._g(_vm._b({ directives: [{ name: "show", rawName: "v-show", value: _vm.display, expression: "display" }], staticClass: "slider-item", style: { zIndex: _vm.zIndex, transition: "all " + _vm.speed / 1e3 + "s" } }, "div", _vm.$attrs, false), _vm.$listeners), [_vm._t("default")], 2)]);
};
...
var __vue_inject_styles__$1 = function(inject) {
  ...
  inject("data-v-31f46842_0", { source: ".slider-item[data-v-31f46842]{position:absolute;top:0;left:0;width:100%;height:100%}.normal-left-leave-to[data-v-31f46842],.normal-right-enter[data-v-31f46842]{transform:translateX(-100%)}.normal-left-enter[data-v-31f46842],.normal-right-leave-to[data-v-31f46842]{transform:translateX(100%)}.fade-left-enter[data-v-31f46842],.fade-left-leave-to[data-v-31f46842],.fade-right-enter[data-v-31f46842],.fade-right-leave-to[data-v-31f46842]{opacity:0}.fade-left-leave-to[data-v-31f46842],.fade-right-enter[data-v-31f46842]{transform:translateX(-10px)}.fade-left-enter[data-v-31f46842],.fade-right-leave-to[data-v-31f46842]{transform:translateX(10px)}", map: void 0, media: void 0 });
};
...
var vue_easy_slider_esm_default = plugin;
export {
  __vue_component__ as Slider,
  __vue_component__$1 as SliderItem,
  vue_easy_slider_esm_default as default
};
//# sourceMappingURL=vue-easy-slider.js.map
